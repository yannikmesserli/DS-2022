require([
  ...
  // Make the whole globe visible in Reveal.js presentation:
  document.getElementById("view-container").style.height="800px";
  ...
  const earthquakeLayer = new CSVLayer({
    ...
    elevationInfo: realElevation.featureExpressionInfo, //exaggeratedElevation,
  ...
  earthquakeLayer
    ...
    .then(function(result) {
      ...
      features.forEach(function(earthquake) {
        ...
        // Skip creating the list for the demo
